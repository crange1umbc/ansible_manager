...
class AuthenticationManagement(VapiStruct):
    ...
    def __init__(self,
        ...
        :param vc_groups: List of VCGroups.
        :type  identity_sources: :class:`list` of :class:`IdentitySource` or ``None``
        :param identity_sources: List of Identity Sources added to VC.
...
class VCGroups(VapiStruct):
    ...
    def __init__(self,
        ...
        :param principal: Unique name of the VC group.
        :type  description: :class:`str` or ``None``
        :param description: VCGroup description.
        ...
        :param members: List of members present in the vcGroup.
        """
...
class IdentitySource(VapiStruct):
    ...
    Identity Source present in vCenter.
    ...
    def __init__(self,
        ...
        :param identity_source_type: Identity Source Type.
        :type  names: :class:`list` of :class:`str`
        :param names: Identity Source name.
        :type  alias: :class:`str` or ``None``
        :param alias: Alias for Identity Source.
        """
