...
class Batch(VapiInterface):
    ...
    def create(self,
        ...
        JSON-encoded string). This API is deprecated. Instead, use the
        hierarchical API in the NSX-T policy API. 
        Support for batched operations will be removed from a future NSX
        release. For policy APIs, use the hierarchical API to submit a set of
        updates as a single operation. For other APIs, submit the operations as
...
class TransportNodes(VapiInterface):
    ...
    def create(self,
        ...
        provided under node_deployment_info. This api is now deprecated. Please
        use new api -
    ...
    def delete(self,
        ...
        without uninstalling the NSX components from the host. This api is now
    ...
    def list(self,
        ...
        overlay. This api is now deprecated. Please use new api -
