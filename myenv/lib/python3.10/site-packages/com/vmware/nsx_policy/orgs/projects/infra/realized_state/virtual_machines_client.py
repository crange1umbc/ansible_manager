...
#
# vAPI stub file for package com.vmware.nsx_policy.orgs.projects.infra.realized_state.virtual_machines.
#---------------------------------------------------------------------------
...
class Tags(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.orgs.projects.infra.realized_state.virtual_machines.tags'
    """
...
class _TagsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/orgs/{org-id}/projects/{project-id}/infra/realized-state/virtual-machines/{virtual-machine-id}/tags',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.orgs.projects.infra.realized_state.virtual_machines.tags',
