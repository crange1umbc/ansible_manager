...
class IdsEvents(VapiInterface):
    ...
    """
    CREATE_CONTEXT_PROJECTS = "ALL_PROJECTS"
    """
    Possible value for ``context`` of method :func:`IdsEvents.create`.
    ...
    def create(self,
        ...
        :type  policy_ids_event_data_request: :class:`com.vmware.nsx_policy.model_client.PolicyIdsEventDataRequest`
        :param policy_ids_event_data_request: (required)
        :type  context: :class:`str` or ``None``
        :param context: Tenancy Context of the API request (optional)
...
class IdsSummary(VapiInterface):
    ...
    CREATE_CONTEXT_PROJECTS = "ALL_PROJECTS"
    """
    Possible value for ``context`` of method :func:`IdsSummary.create`.
...
class SignatureVersions(VapiInterface):
    ...
    def get(self,
        ...
        :rtype: :class:`com.vmware.nsx_policy.model_client.IdsSignatureVersion`
...
class _IdsEventsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_input_type = type.StructType('operation-input', {
            'policy_ids_event_data_request': type.ReferenceType('com.vmware.nsx_policy.model_client', 'PolicyIdsEventDataRequest'),
            'context': type.OptionalType(type.StringType()),
        })
        create_error_dict = {
            'com.vmware.vapi.std.errors.invalid_request':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'),
...
class _SignatureVersionsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/infra/settings/firewall/security/intrusion-services/signature-versions/{version-id}',
            path_variables={
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.nsx_policy.model_client', 'IdsSignatureVersion'),
                'errors': get_error_dict,
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
