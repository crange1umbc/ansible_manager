...
class ExternalPool(VapiInterface):
    ...
    required. This class was added in vSphere API 8.0.0.10200.
    """
    ...
    class Status(Enum):
        ...
        ESX host. This enumeration was added in vSphere API 8.0.0.10200.
    ...
    class AddResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param currently_available: Currently available amount of entropy in bytes in the external
                entropy pool. This attribute was added in vSphere API 8.0.0.10200.
            ...
            :param low_watermark: A threshold value in bytes. An audit record will be logged when
                ...
                value. This attribute was added in vSphere API 8.0.0.10200.
            ...
            :param inactive_source_timeout: A timeout period in seconds within which the client must call
                ...
                This attribute was added in vSphere API 8.0.0.10200.
            """
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param status: This flag indicates entropy service is enabled or not in a ESX
                host. This attribute was added in vSphere API 8.0.0.10200.
            :type  capacity: :class:`long`
            :param capacity: Capacity of external entropy pool in bytes. This attribute was
                added in vSphere API 8.0.0.10200.
            ...
            :param inactive_source_timeout: A timeout period in seconds within which the client must call
                ...
                lost.. This attribute was added in vSphere API 8.0.0.10200.
                This attribute is optional and it is only relevant when the value
                of ``status`` is :attr:`ExternalPool.Status.ENABLED`.
            """
            self.status = status
    ...
    def get(self,
        ...
        level. This method was added in vSphere API 8.0.0.10200.
